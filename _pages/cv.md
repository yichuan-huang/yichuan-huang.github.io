...
* **Research Assistant (Remote)**, Tsinghua University, Department of Automation, Beijing, China, Sep. 2025--Present
  ...
  * Developed a custom 2-DOF robotic arm environment for sim-to-sim transfer research, revealing and systematically analyzing practical hardware bottlenecks in RL, particularly the severe vulnerabilities caused by the lack of MoCap modules.
...
* **Intern (Remote)**, University of Science and Technology of China, Hefei, China, May 2024--Jul. 2024
  ...
  * Explored CNN models for computer vision classification tasks.
  * Implemented Deep Q-Network (DQN) methods to improve agent decision-making in gaming environments.
  * Utilized multimodal generative AI for vision understanding and retrieval.

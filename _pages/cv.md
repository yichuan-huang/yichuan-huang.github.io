...
* **Research Assistant (Onsite & Remote)**, Xi'an Jiaotong University, Bioinspired Engineering & Biomechanics Center, Xi'an, China, Jul. 2024--Jan. 2026
  ...
  * The team’s manuscript, “OsteoSight: Label-Free Cell Osteogenic Fate Inference from Conventional Microscopy,” is currently under submission/review. WSCON was warm-started using 156 pixel-aligned confocal DIC–fluorescence image pairs and subsequently adapted using 2,106 unpaired wide-field phase-contrast images, while the complete framework was evaluated across microscopy modalities, donor age groups, and cell types to support interpretable three-stage osteogenic fate inference.
